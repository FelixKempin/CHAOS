    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True, verbose_name='Zuletzt geändert')),
                ('context', models.TextField(blank=True, verbose_name='Kontext (optional)')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
